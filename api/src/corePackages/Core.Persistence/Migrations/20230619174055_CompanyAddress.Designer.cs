...
namespace Core.Persistence.Migrations
{
    ...
    [Migration("20230619174055_CompanyAddress")]
            ...
            modelBuilder.Entity("Core.Domain.Entities.OperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 6, 19, 20, 40, 54, 860, DateTimeKind.Local).AddTicks(113),
                            IsDeleted = false,
                            Name = "admin",
                            Status = 1
                        });
            ...
            modelBuilder.Entity("Core.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastName = "Admin",
                            ModifiedBy = "",
                            PasswordHash = new byte[] { 174, 197, 78, 115, 193, 156, 46, 134, 225, 132, 130, 242, 118, 241, 152, 92, 177, 139, 111, 61, 17, 47, 84, 98, 53, 145, 166, 85, 225, 1, 22, 86, 133, 113, 38, 149, 94, 119, 115, 55, 141, 228, 252, 129, 89, 193, 4, 102, 81, 92, 11, 219, 178, 89, 63, 177, 172, 20, 138, 212, 10, 56, 31, 29 },
                            PasswordSalt = new byte[] { 22, 219, 118, 131, 59, 81, 7, 147, 116, 67, 56, 195, 83, 237, 90, 15, 10, 178, 117, 32, 78, 178, 167, 184, 87, 156, 242, 206, 123, 104, 132, 248, 38, 210, 130, 14, 103, 18, 66, 160, 245, 251, 216, 18, 114, 47, 111, 42, 162, 21, 24, 10, 202, 177, 238, 189, 169, 64, 177, 92, 26, 34, 152, 35, 156, 241, 253, 68, 58, 54, 239, 49, 197, 250, 72, 113, 164, 28, 25, 139, 206, 7, 115, 147, 68, 170, 148, 82, 241, 214, 8, 42, 153, 140, 212, 18, 38, 65, 42, 156, 4, 252, 248, 186, 190, 1, 207, 212, 254, 25, 163, 210, 146, 238, 87, 167, 76, 108, 137, 230, 110, 161, 226, 255, 109, 184, 82, 149 },
                            Status = 1,
                            UserType = 1
                        });
                });
            ...
            modelBuilder.Entity("Core.Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6c948d64-3766-496a-b50f-f5063354d814"),
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2023, 3, 6, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDeleted = false,
                            ModifiedBy = "",
