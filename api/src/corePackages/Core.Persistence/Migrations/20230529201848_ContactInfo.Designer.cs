...
namespace Core.Persistence.Migrations
{
    ...
    [Migration("20230529201848_ContactInfo")]
            ...
            modelBuilder.Entity("Core.Domain.Entities.OperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 5, 29, 23, 18, 48, 760, DateTimeKind.Local).AddTicks(2714),
                            IsDeleted = false,
                            Name = "admin",
                            Status = 1
                        });
            ...
            modelBuilder.Entity("Core.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastName = "Admin",
                            ModifiedBy = "",
                            PasswordHash = new byte[] { 117, 158, 25, 159, 222, 17, 8, 201, 75, 12, 79, 145, 63, 119, 204, 0, 168, 157, 94, 71, 47, 103, 21, 194, 43, 228, 212, 227, 192, 206, 129, 86, 192, 146, 9, 116, 231, 88, 8, 166, 87, 137, 1, 160, 110, 123, 130, 144, 38, 71, 175, 40, 76, 144, 207, 76, 45, 239, 188, 144, 163, 88, 213, 17 },
                            PasswordSalt = new byte[] { 241, 244, 191, 199, 232, 61, 68, 52, 163, 136, 234, 15, 152, 33, 206, 86, 106, 162, 122, 230, 22, 57, 33, 101, 80, 176, 205, 92, 52, 167, 176, 105, 119, 221, 210, 132, 249, 105, 51, 160, 19, 217, 184, 158, 109, 38, 234, 129, 31, 115, 122, 3, 66, 114, 199, 252, 0, 254, 12, 225, 180, 83, 153, 166, 113, 64, 99, 159, 224, 158, 81, 12, 157, 96, 236, 6, 77, 235, 15, 2, 186, 129, 75, 239, 182, 156, 188, 12, 12, 167, 94, 51, 249, 69, 205, 91, 177, 108, 116, 247, 186, 38, 116, 66, 23, 174, 189, 220, 176, 159, 14, 41, 61, 251, 187, 213, 85, 232, 175, 9, 221, 217, 250, 75, 165, 200, 201, 149 },
                            Status = 1,
                            UserType = 1
                        });
                });
            ...
            modelBuilder.Entity("Core.Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("17335687-bdcc-4b95-a0e0-a0496855fb62"),
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2023, 3, 6, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDeleted = false,
                            ModifiedBy = "",
