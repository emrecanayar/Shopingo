...
namespace Core.Persistence.Migrations
{
    ...
    [Migration("20230629151201_LogEntityModified")]
    partial class LogEntityModified
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Domain.Entities.OperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 6, 29, 18, 12, 1, 33, DateTimeKind.Local).AddTicks(1935),
                            IsDeleted = false,
                            Name = "admin",
                            Status = 1
                        });
            ...
            modelBuilder.Entity("Core.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastName = "Admin",
                            ModifiedBy = "",
                            PasswordHash = new byte[] { 110, 67, 25, 216, 46, 45, 139, 15, 153, 120, 171, 145, 131, 168, 99, 220, 38, 45, 38, 253, 181, 104, 92, 230, 123, 18, 114, 62, 33, 226, 138, 183, 69, 4, 114, 17, 114, 72, 177, 48, 218, 195, 51, 51, 121, 153, 58, 208, 14, 201, 229, 238, 23, 239, 57, 234, 162, 219, 247, 182, 76, 48, 124, 211 },
                            PasswordSalt = new byte[] { 101, 58, 24, 24, 191, 149, 47, 202, 190, 45, 163, 102, 108, 174, 11, 24, 154, 152, 188, 141, 152, 235, 73, 32, 32, 3, 202, 175, 35, 252, 251, 230, 151, 214, 45, 63, 15, 74, 161, 123, 88, 15, 88, 112, 214, 125, 123, 204, 17, 63, 101, 157, 246, 215, 77, 52, 28, 124, 109, 44, 166, 91, 247, 119, 219, 71, 225, 188, 39, 158, 123, 52, 175, 153, 49, 152, 56, 82, 202, 18, 133, 239, 157, 240, 182, 197, 78, 13, 74, 58, 68, 87, 98, 169, 254, 94, 199, 215, 250, 243, 164, 10, 86, 126, 22, 42, 228, 84, 130, 164, 168, 154, 30, 90, 194, 255, 227, 222, 145, 215, 70, 191, 242, 155, 176, 194, 242, 91 },
                            Status = 1,
                            UserType = 1
                        });
                });
            ...
            modelBuilder.Entity("Core.Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("091a4649-e1aa-4e8d-91cc-58c82a37d9eb"),
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2023, 3, 6, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDeleted = false,
                            ModifiedBy = "",
